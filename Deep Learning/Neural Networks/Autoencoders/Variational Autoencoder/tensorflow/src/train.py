"""Training script for the TensorFlow variational autoencoder."""
...
def train(config: VAEConfig = CONFIG) -> Dict[str, float]:
    ...
    checkpoint_path = config.artifact_dir / "variational_autoencoder.weights.h5"
    callbacks = [
    ...
    val_kl = history.history.get("val_kl_divergence", [0.0])
