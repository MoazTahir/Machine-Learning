"""Training utilities for the PyTorch denoising autoencoder."""
...
def _run_epoch(
    ...
    for noisy, clean in loader:
        ...
        psnr_accum += psnr(recon.detach(), clean)
        total_batches += 1
...
def train_denoising_autoencoder(config: DenoisingConfig, model: nn.Module) -> Dict[str, List[float]]:
    ...
    best_val = float("inf")
    artifact_path = config.artifact_dir / "denoising_autoencoder.pt"
