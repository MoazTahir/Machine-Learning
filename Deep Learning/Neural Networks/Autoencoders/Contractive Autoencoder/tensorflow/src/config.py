"""Configuration for the TensorFlow contractive autoencoder."""
...
class ContractiveConfig:
    data_dir: Path = Path("artifacts/tensorflow_contractive_ae/data")
    artifact_dir: Path = Path("artifacts/tensorflow_contractive_ae")
    batch_size: int = 256
    num_epochs: int = 25
...
def configure_devices(config: ContractiveConfig) -> None:
