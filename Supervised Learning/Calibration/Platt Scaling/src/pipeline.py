"""Training pipeline for Platt scaling calibration."""
...
class PlattScalingPipeline:
    """Wraps base model + sigmoid calibration."""
...
def train_and_persist(config: PlattScalingConfig | None = None) -> Dict[str, float]:
    pipeline = PlattScalingPipeline(config)
