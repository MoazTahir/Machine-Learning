"""Training pipeline for Poisson regression."""
...
class PoissonRegressionPipeline:
    """Encapsulates preprocessing, training, and persistence."""
    ...
    def train(self) -> Dict[str, float]:
        ...
        metrics: Dict[str, float] = {
            "mean_poisson_deviance": float(mean_poisson_deviance(y_val, predictions)),
...
def train_and_persist(
    config: PoissonRegressionConfig | None = None,
) -> Dict[str, float]:
    pipeline = PoissonRegressionPipeline(config)
