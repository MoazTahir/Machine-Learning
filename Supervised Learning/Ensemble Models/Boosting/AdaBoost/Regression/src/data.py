"""Data utilities for the California housing AdaBoost regressor."""
...
def _fetch_dataset(config: AdaBoostRegressionConfig) -> pd.DataFrame:
...
def load_dataset(config: AdaBoostRegressionConfig = CONFIG) -> pd.DataFrame:
...
def build_features(
    df: pd.DataFrame, config: AdaBoostRegressionConfig = CONFIG
...
def train_validation_split(
    config: AdaBoostRegressionConfig = CONFIG,
