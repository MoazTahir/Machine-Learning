...
def _fetch_dataset(config: GradientBoostingClassificationConfig) -> pd.DataFrame:
...
def load_dataset(config: GradientBoostingClassificationConfig = CONFIG) -> pd.DataFrame:
...
def build_features(
    df: pd.DataFrame, config: GradientBoostingClassificationConfig = CONFIG
...
def train_validation_split(
    config: GradientBoostingClassificationConfig = CONFIG,
