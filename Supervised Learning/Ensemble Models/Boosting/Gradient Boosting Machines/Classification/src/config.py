"""Configuration for the wine gradient boosting classifier."""
...
class GradientBoostingClassificationConfig:
    """Immutable configuration for the gradient boosting classifier."""
    ...
    model_path: Path = artifact_dir / "gradient_boosting_classifier.joblib"
...
CONFIG = GradientBoostingClassificationConfig()
