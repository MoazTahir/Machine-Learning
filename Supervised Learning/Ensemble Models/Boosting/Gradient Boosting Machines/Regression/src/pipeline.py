"""Training utilities for the California housing gradient boosting regressor."""
...
class CaliforniaGradientBoostingPipeline:
    """Compose gradient boosting training, evaluation, and persistence."""
...
def train_and_persist(
    ...
    pipeline = CaliforniaGradientBoostingPipeline(config)
