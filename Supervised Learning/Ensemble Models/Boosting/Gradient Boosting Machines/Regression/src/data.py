"""Data utilities for the California housing gradient boosting regressor."""
...
def _fetch_dataset(config: GradientBoostingRegressionConfig) -> pd.DataFrame:
...
def load_dataset(config: GradientBoostingRegressionConfig = CONFIG) -> pd.DataFrame:
...
def build_features(
    df: pd.DataFrame, config: GradientBoostingRegressionConfig = CONFIG
...
def train_validation_split(
    config: GradientBoostingRegressionConfig = CONFIG,
