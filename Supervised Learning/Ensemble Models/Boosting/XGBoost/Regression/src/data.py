"""Data utilities for the California housing XGBoost regressor."""
...
def _fetch_dataset(config: XGBoostRegressionConfig) -> pd.DataFrame:
...
def load_dataset(config: XGBoostRegressionConfig = CONFIG) -> pd.DataFrame:
...
def build_features(
    df: pd.DataFrame, config: XGBoostRegressionConfig = CONFIG
...
def train_validation_split(
    config: XGBoostRegressionConfig = CONFIG,
